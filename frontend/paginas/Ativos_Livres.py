...
def render():
    ...
    # 🔄 Botão para buscar preços no Yahoo
    ...
    # 🔄 Carrega dados da tabela ativos_livres
    ...
    contas_excluir_input = st.text_area("Códigos de contas separadas por vírgula", "", height=30, width=100)
    ...
    rentabilidade_minima = col7.number_input("Rentabilidade Maior que", min_value=-100.0, value=-100.0)
